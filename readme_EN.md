...
Translation contributors and translation agents should follow the public [AGENTS.md](https://github.com/kohakunamori/SCSPTranslationData/blob/TransData/AGENTS.md) and [CONTRIBUTING.md](https://github.com/kohakunamori/SCSPTranslationData/blob/TransData/CONTRIBUTING.md). The translation repository now publishes the SCSP 2.17.0 main `localizetext` current-source snapshot (5,631 tables / 138,036 source rows) and the current Drama source corpus (267/267 scenarios / 11,402 dialogue rows) together with the maintained `drama.json` translation corpus. The standalone audits currently report 138,036/138,036 localizetext rows mapped with 0 actionable rows and 11,402/11,402 Drama rows mapped with 0 missing/extra/kana rows. Public terminology/name data, translation-memory generation, Agent review schemas/tooling, a community quality backlog, strict exact-source canonicalization, CI, and dedicated translation/source-update Issue forms and PR templates remain fully reproducible without private environments.
