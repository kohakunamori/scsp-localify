...
utils\bin\premake5 --file=premake-probe.lua vs2022 || exit /b 1
...
"%MSBUILD%" build-probe\SCSP-Localify-Probe.sln /m /p:Configuration=Release /p:Platform=x64 /v:minimal
exit /b %ERRORLEVEL%
