...
utils\bin\premake5 --file=premake-full-2.17.lua vs2022 || exit /b 1
...
"%MSBUILD%" build-full-2.17\SCSP-Localify-Full-2.17.sln /m /p:Configuration=Release /p:Platform=x64 /v:minimal
exit /b %ERRORLEVEL%
